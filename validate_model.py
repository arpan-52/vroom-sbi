...
def generate_test_cases(
    ...
    simulator = RMSimulator(freq_file=freq_file, n_components=n_components, base_noise_level=base_noise_level)
...
def plot_residuals(
    ...
    ax.fill_between(freq_ghz, -base_noise_level, base_noise_level, alpha=0.3, color="red", label=f"Base noise: {base_noise_level:.4f}")
    ax.set_xlabel("Frequency (GHz)")
